...
public class CategoryModify extends JDialog {

	protected static final Category CategoryModify = null;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CategoryModify frame = new CategoryModify();
	...
	public CategoryModify() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent arg0) {
				...
				// Category category = (Category) CategoryModify.
				// .getSelectedItem();
				//
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						CategoryModify category = new CategoryModify(0,
								textField.getText());

						System.out.println(category);

						CategoryDao.getInstanceof().add(CategoryModify);
	...
	public CategoryModify(int i, String text) {
